...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        :root {
            /* This tells the browser to render native UI (like dropdowns) in dark mode */
            color-scheme: dark; 
        ...
        /* Specialized Styling for Select */
        .field-wrap select {
            appearance: none;
        ...
        /* FIX: Styling the options to be dark */
        .field-wrap select option {
            background-color: #1c1c1e; /* Solid dark color */
            color: #E8E8E8;
        }
...
<body>
    ...
    <div class="left-panel">
        ...
        <div class="left-content">
            ...
            <p>Create a resident account to start submitting and tracking barangay incident reports directly to local
                officials.</p>
            <div class="features">
                <div class="feature-item">
                    <div class="feature-dot"><i class="fa fa-file-alt"></i></div>
                    <div class="feature-text"><strong>Submit Reports</strong><span>File incident reports with photo
                            evidence</span></div>
                </div>
                <div class="feature-item">
                    <div class="feature-dot"><i class="fa fa-clock"></i></div>
                    <div class="feature-text"><strong>Track Status</strong><span>Monitor your reports from pending to
                            resolved</span></div>
                </div>
                <div class="feature-item">
                    <div class="feature-dot"><i class="fa fa-shield-alt"></i></div>
                    <div class="feature-text"><strong>Secure & Private</strong><span>Your information is protected at
                            all times</span></div>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="field-group">
                ...
                <div class="file-input-wrap">
                    ...
                    <input type="file" id="profile_photo_real" name="profile_photo" accept="image/*"
            ...
            <div class="field-group">
                ...
                <div class="field-wrap">
                    <input type="tel" id="phone" name="phone" placeholder="+63 900 000 0000" value="{{ old('phone') }}">
                </div>
            </div>
